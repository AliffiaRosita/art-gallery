                ...
                <form action="{{route('user.update',$user)}}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-7">
                            <input name="name" value="{{ old('name',$user->name) }}" type="text" id="text-input"   class="form-control @error('name') is-invalid  @enderror">
                            @error('name')
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-7">
                            <input name="email" value="{{ old('email',$user->email) }}" type="email" id="text-input"   class="form-control @error('email') is-invalid  @enderror">
                            @error('email')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="text-input" class=" form-control-label ">Password <small ><br> Note: leave input blank if not change the password</small></label>
                        </div>
                        <div class="col-12 col-md-7">
